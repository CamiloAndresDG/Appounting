...
-- -----------------------------------------------------
-- Table `appounting`.`persona`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `appounting`.`persona` ;

CREATE TABLE IF NOT EXISTS `appounting`.`persona` (
...
CREATE TABLE IF NOT EXISTS `appounting`.`cuenta` (
  ...
  `persona_usuario` VARCHAR(80) NOT NULL,
  PRIMARY KEY (`numero_cuenta`),
  INDEX `fk_cuenta_persona_idx` (`persona_usuario`),
  CONSTRAINT `fk_cuenta_persona1`
    FOREIGN KEY (`persona_usuario`)
    REFERENCES `appounting`.`persona` (`usuario`)
);
