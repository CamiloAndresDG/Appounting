...
public class TransaccionesAdapter extends RecyclerView.Adapter<TransaccionesAdapter.ViewHolder>{
    ...
    final TransaccionesAdapter.OnItemClickListener listener;

    public interface OnItemClickListener{
        void onItemClick(TransaccionDTO transaccionDTO);
    }

    public TransaccionesAdapter(ArrayList<TransaccionDTO> transaccionesArrayList, Context context, TransaccionesAdapter.OnItemClickListener listener) {
